...
module.exports = function loader(content) {
  ...
  const parsedResourceQuery = this.resourceQuery ? _loaderUtils.default.parseQuery(this.resourceQuery) : {};
  const config = Object.assign({}, _loaderUtils.default.getOptions(this), parsedResourceQuery);
  ...
  if (config.format) {
    ...
    ext = _path.default.extname(this.resourcePath).replace(/\./, '');
    mime = MIMES[ext];
  ...
  if (config.disable) {
    ...
    const fileName = _loaderUtils.default.interpolateName(loaderContext, name, {
